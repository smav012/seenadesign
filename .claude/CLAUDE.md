...
- **Do NOT add a `Co-Authored-By: Claude ...` trailer to commit messages on this repo.** The trailers were stripped from all 75 commits via a history rewrite on 2026-08-19; new ones would re-add Claude to the GitHub contributors list.
